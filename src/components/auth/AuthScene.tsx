      ...
      >
        <div className="flex items-center gap-1.5 mb-2">
          ...
          <span className="text-[10px] font-semibold text-white/70 uppercase tracking-wide">
            {t.auth.scene.insightBadge}
          </span>
        </div>
        <p className="text-sm text-white leading-snug">
          {t.auth.scene.insightTextBefore}{" "}
          <span className="font-bold">{t.auth.scene.insightPercent}</span>{" "}
          {t.auth.scene.insightTextAfter}
        </p>
      </FloatCard>
