    ...
    items: [
      {
        ...
        answer:
          "Tap the add button (FAB) on the Dashboard or Transactions page, then fill in the amount, category, and date. It's saved instantly and shows up in your history and related charts.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Open the Goals menu, pick a category, and set its monthly limit. The limit applies automatically every month (no need to reset it), while your spending progress is always calculated for the current month.",
      },
      {
        question: "How do I record a debt or a loan I'm owed?",
        answer:
          "Open the Debts menu, tap add, then choose the type (debt/receivable), the amount, and the person involved. For installments, you can log payments in stages and see the full payment history on that debt's card.",
      },
      {
        question: "How do I set up a recurring transaction?",
        answer:
          "Open the Recurring menu and add a new template with a category, amount, and a day of the month it repeats on. Templates can be turned on or off anytime, and transactions are created automatically on the date you set.",
      },
      {
        question: "Where can I see my monthly financial report?",
        answer:
          "Open the Reports menu to see a cash flow summary, category charts, and a comparison across recent months.",
      },
      {
        question: "How do I enable the AI insight feature?",
        answer:
          "Open Profile > AI Settings, choose an AI provider, enter your own API key, then pick a model. Once saved, AI-powered insights and receipt scanning are switched on.",
      },
      {
        question: "How do I create or switch wallets?",
        answer:
          "Open Profile > Manage Wallets to create a new wallet, switch between wallets, or manage existing ones. You can also pick the active wallet from the switcher at the top of the page.",
      },
      {
        question: "How do I switch between light and dark mode?",
        answer:
          "Tap the theme icon in the top-right corner of the header to toggle between light and dark mode. Your choice is saved automatically for next time.",
      },
    ],
  },
};
