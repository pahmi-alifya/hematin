...
export const FAB_ITEMS: FabItemConfig[] = [
  { icon: Camera, label: 'Scan', color: '#10B981', shadow: 'rgba(16,185,129,0.45)', href: '/scan' },
  { icon: Target, label: 'Goals', color: '#8B5CF6', shadow: 'rgba(139,92,246,0.45)', href: '/goals' },
  { icon: CreditCard, label: 'Utang', color: '#F59E0B', shadow: 'rgba(245,158,11,0.45)', href: '/debts' },
  { icon: Settings, label: 'Setting', color: '#6366F1', shadow: 'rgba(99,102,241,0.45)', href: '/settings' },
]
